...
public:
  ...
  exc_vxc_type_neo_rks eval_neo_exc_vxc ( const MatrixType&, const MatrixType&, const MatrixType& );
  exc_vxc_type_neo_uks  eval_neo_exc_vxc ( const MatrixType&, const MatrixType&, const MatrixType&, const MatrixType& );
